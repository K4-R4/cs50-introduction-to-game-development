            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local baseHP = self.playerPokemon.HP
                        local baseAttack = self.playerPokemon.attack
                        local baseDefense = self.playerPokemon.defense
                        local baseSpeed = self.playerPokemon.speed
                        ...
                        self:fadeOutWhite(function() end)
                    end
                end)
            end)
        end))
